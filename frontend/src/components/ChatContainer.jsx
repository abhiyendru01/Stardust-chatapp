...
const ChatContainer = () => {
  ...
  return (
      <div className="flex-1 flex flex-col h-full max-h-screen">
        {/* Chat Header: sticky position to avoid it moving with keyboard */}
        <div className="sticky top-0 z-10 bg-base-100 p-0 shadow-md">
          <ChatHeader />
        </div>
    
        {/* Messages Section: Add some padding at the bottom so the message input doesn't overlap with the keyboard */}
        <div className="flex-1 overflow-y-auto p-4 space-y-4 max-h-[calc(100vh-14rem)]">
          {messages.length > 0 ? (
