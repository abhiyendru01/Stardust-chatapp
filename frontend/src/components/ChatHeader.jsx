...
const ChatHeader = () => {
  ...
  return (
    <>
      ...
      <div className="p-3.5 sticky top-0 z-10 border-b-2 rounded-b-2xl  border-primary/40 border-base-200 bg-base-200 backdrop-blur-md flex justify-between items-center h-20">
