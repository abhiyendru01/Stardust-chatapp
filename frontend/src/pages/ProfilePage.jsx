...
const ProfilePage = () => {
  ...
  <button
    title="Logout"
    className="cursor-pointer flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-base-300 text-base-content hover:bg-primary active:border active:border-red-400 duration-300"
