    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="overflow-y-auto w-full py-3 px-3 flex-grow space-y-1">
        {filteredCalls.length > 0 ? (
            ...
            >
              ...
              <div className="relative mx-auto lg:mx-0">
                <img
                  ...
                  alt={call.receiver?.fullName || "Unknown User"}
              ...
              <div className="flex-grow text-left truncate">
                <div className="font-semibold">
                  {call.receiver?.fullName || "Unknown User"}
                </div>
          ...
          <div className="text-center text-zinc-500 bg-base-100 py-6">
            <p className="text-lg font-medium">No recent calls</p>
            <p className="text-sm">Your recent call history will appear here.</p>
          </div>
        )}
      </div>
